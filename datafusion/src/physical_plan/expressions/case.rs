...
fn array_equals(
    ...
    match data_type {
        ...
        DataType::Int64Decimal(1) => {
            array_equals!(array::Int64Decimal1Array, when_value, base_value, eq)
        }
        DataType::Int64Decimal(2) => {
            array_equals!(array::Int64Decimal2Array, when_value, base_value, eq)
        }
        DataType::Int64Decimal(3) => {
            array_equals!(array::Int64Decimal3Array, when_value, base_value, eq)
        }
        DataType::Int64Decimal(4) => {
            array_equals!(array::Int64Decimal4Array, when_value, base_value, eq)
        }
        DataType::Int64Decimal(5) => {
            array_equals!(array::Int64Decimal5Array, when_value, base_value, eq)
        }
