    ...
    IndexType::Native: ToPrimitive,
{
    ...
    match values.data_type() {
        ...
        DataType::Int64Decimal(0) => downcast_take!(Int64Decimal0Type, values, indices),
        DataType::Int64Decimal(1) => downcast_take!(Int64Decimal1Type, values, indices),
        DataType::Int64Decimal(2) => downcast_take!(Int64Decimal2Type, values, indices),
        DataType::Int64Decimal(3) => downcast_take!(Int64Decimal3Type, values, indices),
        DataType::Int64Decimal(4) => downcast_take!(Int64Decimal4Type, values, indices),
        DataType::Int64Decimal(5) => downcast_take!(Int64Decimal5Type, values, indices),
        DataType::Int64Decimal(10) => downcast_take!(Int64Decimal10Type, values, indices),
...
trait VarlengthArray: Array + From<ArrayData> {
