...
pub fn new_null_array(data_type: &DataType, length: usize) -> ArrayRef {
    ...
    match data_type {
        ...
        DataType::Int64Decimal(1) => {
            new_null_sized_array::<Int64Decimal1Type>(data_type, length)
        }
        DataType::Int64Decimal(2) => {
            new_null_sized_array::<Int64Decimal2Type>(data_type, length)
        }
        DataType::Int64Decimal(3) => {
            new_null_sized_array::<Int64Decimal3Type>(data_type, length)
        }
        DataType::Int64Decimal(4) => {
            new_null_sized_array::<Int64Decimal4Type>(data_type, length)
        }
        DataType::Int64Decimal(5) => {
            new_null_sized_array::<Int64Decimal5Type>(data_type, length)
        }
        DataType::Int64Decimal(10) => {
